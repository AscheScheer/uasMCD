...
<body>
    <div class="container">
        ...
        <div class="card tabeldata">
            <div class="card-header">
                <div class="row">
                    <div class="col col-sm-9 pt-1">Data Pelanggan</div>
                    <div class="col col-sm-3">
                        <button type="button" id="generate" class="btn btn-primary btn-sm float-end mx-2">Kesimpulan</button>
