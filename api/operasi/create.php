...
$item->selisihpelayanankasir = calculateTimeDifference($data->awalpelayanan, $data->waktudatang);
$item->selisihkeluarantrian = calculateTimeDifference($data->selesai, $data->waktudatang);
